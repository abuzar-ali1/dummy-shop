        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight">
              ...
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-sky-700">
                modern essentials
              </span>
            </h1>

            <p className="text-gray-600 max-w-2xl text-lg">
              Handpicked quality, thoughtful design and honest prices. Discover
              curated pieces for home, work and travel — made to last. Free
              shipping over <strong>$50</strong>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <FillHoverButton href="#collections">
                Explore Collections
              </FillHoverButton>
            </div>
